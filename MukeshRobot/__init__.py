...
if ENV:
    ...
    DB_URI = os.environ.get("DATABASE_URL", "postgres://avnadmin:AVNS_hr7jmlGkArYP6uTQqDv@pg-1f89dd4b-anirbanop51-3a7a.e.aivencloud.com:22957/defaultdb?sslmode=require")
